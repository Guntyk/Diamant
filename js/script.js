...
//!=====Selector Menu Start=====
$("ul.selector__menu").on(
  "click",
  "li:not(.selector__item_active)",
  function () {
    $(this)
      .addClass("selector__item_active")
      .siblings()
      .removeClass("selector__item_active")
      .closest("body")
      .find("section.block__content")
      .removeClass("block__content_active")
      .eq($(this).index())
      .addClass("block__content_active");
  }
);
//!=====Selector Menu Start=====
//!=====Carousel Start=====
...
//!=====More Button End=====
//!=====Location Start=====
$("ul.location__list").on(
  "click",
  "li:not(.location__mark_active)",
  function () {
    $(this)
      .addClass("location__mark_active")
      .siblings()
      .removeClass("location__mark_active")
      .closest("body")
      .find("iframe.location__map")
      .removeClass("location__map_active")
      .eq($(this).index())
      .addClass("location__map_active");
  }
);
//!=====Location End=====
//!=====Footer Selector Menu Start=====
$("ul.footer__menu__selector").on(
  "click",
  "li:not(.selector__item_active)",
  function () {
    $(this)
...
document.getElementById(
  "currentYear"
).textContent = `© ${new Date().getFullYear()} Diamant-Elite`;
